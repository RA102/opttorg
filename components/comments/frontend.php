...
if ($do=='add'){
	...
	$comment['rating1'] = cmsCore::request('rating1', 'int', 0);
	$comment['rating2'] = cmsCore::request('rating2', 'int', 0);
	$comment['rating3'] = cmsCore::request('rating3', 'int', 0);
	//$comment['rating4'] = cmsCore::request('rating4', 'int', 0);
