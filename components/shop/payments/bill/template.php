...
function propis($rub)
{
$dop0 = Array("тенге","тысяч","миллионов","миллиардов");
$dop1 = Array("тенге","тысяча","миллион","миллиард");
$dop2 = Array("тенге","тысячи","миллиона","миллиарда");
...
<html lang="ru">
    ...
    <body>
        ...
        <div id="invoice">
            ...
            <div style="margin-bottom:3mm"><strong><?php echo ucfirst(propis($order['summ_parts'][0])); ?> <?php echo $order['summ_parts'][1]; ?> теин</strong></div>
