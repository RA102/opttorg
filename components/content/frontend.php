...
///////////////////////////////////// VIEW CATEGORY ////////////////////////////////////////////////////////////////////////////////
    if ($do == 'view') {
        ...
        if ($page == 1) {
            $is_pager = 1;
            $inPage->addHead('<link rel="canonical" href="https://sanmarket.kz/' . $cat['seolink'] . '" />');
        } else {
            $is_pager = 0;
        }

        cmsPage::initTemplate('components', $template)->assign('cat', $cat)->assign('is_homepage', (bool)($inCore->menuId() == 1))->assign('showdate', $showdate)->assign('is_pager', $is_pager)->assign('showcomm', $showcomm)->assign('pagetitle', $pagetitle)->assign('subcats', $subcats_list)->assign('cat_photos', $cat_photos)->assign('articles', $content_list)->assign('pagebar', $pagebar)->display($template);
