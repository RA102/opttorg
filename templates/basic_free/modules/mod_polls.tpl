...
{if !$is_voted}
    ...
    {foreach key=answer item=num from=$poll.answers}
     ...
     <div align="center"><input type="button" id="mod_poll_submit" class="btn btn-default" onclick="pollSubmit();" value="{$LANG.POLLS_VOTE} {if $cfg.shownum}({$poll.total_answers}){/if}"></div>
    </form>
