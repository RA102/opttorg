...
<div class="table-responsive">
	<table class="table table-striped">
		<tr>
            <td width="20%"><span>{$LANG.CAT_BOARD}:</span></td>
            <td>
		...
		<tr>
			...
			<td height="35">
				<select name="obtype" id="obtype" style="width:160px;margin-bottom:10px;">
					<option value="0">-- {$LANG.SELECT_CAT} --</option>
				</select>
		...
		<tr class="proptable">
			...
			<td height="35" valign="top">
                {city_input value=$item.city name="city"}
			</td>
		</tr>
		<tr id="before_form">
			<td valign="top">
			...
			<td height="100" valign="top">
				<textarea name="content" class="text-input" style="height:120px" rows="5" id="content">{$item.content|escape:'html'}</textarea>
			</td>
		</tr>
        {if $formsdata}
			...
			<tr>
				...
				<td>
					<select name="pubdays" id="pubdays">
						...
						<option value="10" selected="selected">10 {$LANG.DAYS}</option>
						<option value="14">14 {$LANG.DAYS}</option>
						<option value="30">30 {$LANG.DAYS}</option>
						<option value="50">50 {$LANG.DAYS}</option>
					</select>
				</td>
			</tr>
		{/if}
