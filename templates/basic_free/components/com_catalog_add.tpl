    ...
    <div id="form">
        ...
        <table class="table table-striped">
            <tr>
                ...
                <td><input type="text" name="title" id="title" class="text-input" value="{$item.title|escape:'html'}" style="position:relative;width:100%;" /></td>
            </tr>
            {if $is_admin}
            <tr>
                <td width="20%">
                ...
                <td><select style="position:relative;width:100%;" class="text-input" name="new_cat_id" id="cat_id" >{$cats}</select></td>
            </tr>
            {/if}
            <tr>
                <td width="">
                ...
                <td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><input name="imgfile" type="file" id="imgfile" style="position:relative;width:100%;" /></td>
                            {if $do=='edit_item' && $item.imageurl}
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="text-input" name="price" value="{$item.price|escape:'html'}" style="position:relative;width:100%;" />
                </td>
            </tr>
            <tr>
                <td width="">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="tags" class="text-input" value="{$item.tags|escape:'html'}" style="position:relative;width:100%;" />
                </td>
            </tr>
        {foreach key=id item=field from=$fields}
            <tr>
                ...
                <td>
                    <input style="position:relative;width:100%;"  name="fdata[{$id}]" type="text" class="text-input" value="{if $field.value}{$field.value|escape:'html'}{/if}"/>
                </td>
                {else}
                    <td colspan="2"><strong>{$field.title}:</strong><br />
                        {wysiwyg name="fdata[$id]" value=$field.value height=300 width='100%'}
                    </td>
                {/if}
            </tr>
        {/foreach}
        {if $is_admin}
            <tr>
                ...
                <td>
                    <input type="text" name="meta_keys" class="text-input" value="{$item.meta_keys|escape:'html'}" style="position:relative;width:100%;" />
                </td>
            </tr>
            <tr>
                <td width="">
                ...
                <td>
                    <input type="text" name="meta_desc" class="text-input" value="{$item.meta_desc|escape:'html'}" style="position:relative;width:100%;" />
                </td>
            </tr>
            <tr>
                <td width="">
