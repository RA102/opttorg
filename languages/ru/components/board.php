...
$_LANG['YOU_CANT_ADD_ADV_ANY']    ='Вы не можете добавлять объявления, ибо не можем мы понять, добрый вы человек, али недобрый! Ежели вы уже зарегистрированы у нас, то <a href="/login">входите</a>, в противном же случае зело рекомендуем пройти регистрацию немедля по этой <a href="/login">ссылке</a>!';
