...
function applet_config(){
	...
	if ($do == 'save'){
		...
		$newCFG['marquee'] 	= stripslashes(cmsCore::request('marquee', 'html', ''));
    ...
    <input type="hidden" name="csrf_token" value="<?php echo cmsUser::getCsrfToken(); ?>" />
        <div id="basic">
			<table width="720" border="0" cellpadding="5">
				...
				<tr>				
					<td>
                        <strong>Бегучая строка</strong><br/>
						<span class="hinttext">Можно обернуть в ссылку типа < a href="...</span>
                    </td>
					<td width="350" valign="top">
                        <input name="marquee" type="text" id="marquee" value="<?php echo $config['marquee'];?>" style="width:358px" />
                    </td>
				</tr>				
			</table>
        </div>
