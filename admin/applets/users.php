...
function applet_users()
{
    ...
    if ($do == 'list') {
        ...
        $toolmenu[] = array('icon' => 'user_go.png', 'title' => $_LANG['UPLOADING_USERS'], 'link' => '?view=unloadinguser');
    ...
    if ($do == 'edit' || $do == 'add') {
        ...
        if ($do == 'edit') {
            ...
            cpAddPathway($mod['nickname'], $mod['link']);
            ...
            cpAddPathway($_LANG['AD_USER_ADD'], $_LANG['AD_LINK']);
        }
        ...
        <form action="index.php?view=users" method="post" enctype="multipart/form-data" name="addform" id="addform">
            ...
            <table width="600" border="0" cellpadding="0" cellspacing="10" class="proptable">
                ...
                <tr>
                    ...
                    <td valign="middle">
                        <input name="nickname" type="text" id="login" style="width:220px" value="<?php echo htmlspecialchars($mod['nickname']); ?>"/>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td valign="middle">
                        <input name="email" type="text" id="nickname" style="width:220px" value="<?php echo @$mod['email']; ?>"/>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="middle">
                        <label><input name="is_locked" type="radio" value="1" <?php if ($mod['is_locked']) {
                                echo 'checked="checked"';
                            } ?> /><?php echo $_LANG['YES']; ?></label>
                        <label><input name="is_locked" type="radio" value="0" <?php if (!$mod['is_locked']) {
                                echo 'checked="checked"';
                            } ?> />
