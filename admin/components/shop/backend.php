...
//=================================================================================================//
	...
	if ($opt=='list_items' || $opt=='list_cats' ||
        ...
        $opt=='list_psys'  || $opt=='list_orders' || $opt=='list_discounts'){
...
//=================================================================================================//
	...
	if ($opt=='list_items' || $opt=='list_cats' || $opt=='list_discounts' || $opt=='list_chars' ||
        $opt=='list_vendors' || $opt=='list_delivery' || $opt=='list_psys' || $opt=='list_orders'){
...
//=================================================================================================//
	...
	if ($opt == 'hide_char'){
		if (!isset($_REQUEST['item'])){
			if (isset($_REQUEST['item_id'])){ dbHide('cms_shop_chars', $_REQUEST['item_id']);  }
		} else {
...
//=================================================================================================//
	...
	if ($opt == 'hide_psys'){
		if (!isset($_REQUEST['item'])){
			if (isset($_REQUEST['item_id'])){ dbHide('cms_shop_psys', $_REQUEST['item_id']);  }
		} else {
...
//=================================================================================================//
	...
	if ($opt == 'hide_delivery'){
		if (!isset($_REQUEST['item'])){
			if (isset($_REQUEST['item_id'])){ dbHide('cms_shop_delivery', $_REQUEST['item_id']);  }
		} else {
...
//=================================================================================================//
	...
	if ($opt == 'hide_vendor'){
		if (!isset($_REQUEST['item'])){
			if (isset($_REQUEST['item_id'])){ dbHide('cms_shop_vendors', $_REQUEST['item_id']);  }
		} else {
...
//=================================================================================================//
	...
	if ($opt == 'hide_discount'){
		if (!isset($_REQUEST['item'])){
			if (isset($_REQUEST['item_id'])){ dbHide('cms_shop_discounts', $_REQUEST['item_id']);  }
		} else {
...
//=================================================================================================//
	...
	if ($opt == 'list_delivery'){
		...
		$fields[2]['title'] = 'Цена';       $fields[2]['field'] = 'price';		$fields[2]['width'] = '150';

		$fields[4]['title'] = 'Показ';		$fields[4]['field'] = 'published';	$fields[4]['width'] = '100';
		$fields[4]['do']    = 'opt';        $fields[4]['do_suffix'] = '_delivery';
...
//
//        $fields[1]['title'] = 'Арт.';       $fields[1]['field'] = 'art_no';     $fields[1]['width'] = '60';
//
//		$fields[5]['title'] = 'Название';	$fields[5]['field'] = 'title';		$fields[5]['width'] = '';
//        $fields[5]['link'] = '?view=components&do=config&id='.$_REQUEST['id'].'&opt=edit_item&item_id=%id%';
//		$fields[5]['filter'] = 15;
//
//		$fields[10]['title'] = 'Показ';		$fields[10]['field'] = 'published';	$fields[10]['width'] = '55';
//		$fields[10]['do'] = 'opt'; $fields[10]['do_suffix'] = '_item';
//
//		$fields[15]['title'] = 'Цена';		$fields[15]['field'] = 'id';	$fields[15]['width'] = '90';
//		$fields[15]['prc'] = 'cpPriceInput';
//
//		//ACTIONS
//		$actions = array();
            ...
            <table class="proptable" width="100%" cellpadding="15" cellspacing="2">
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <table width="100%" cellpadding="5" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td valign="top" width="120">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" name="pubdate" type="text" id="pubdate" style="width:120px;" <?php if(@!$mod['pubdate']) { echo 'value="'.date('Y-m-d').'"'; } else { echo 'value="'.$mod['pubdate'].'"'; } ?>/>
                                        <?php
                                            //include javascript
                                            if (@!$mod['pubdate']){
						...
						<table width="100%" cellpadding="5" cellspacing="0" border="0">
							<tr>								
								...
								<td valign="top" width="80">
									...
									<div><input name="ves" type="text" id="ves" style="width:80px" value="<?php echo htmlspecialchars($mod['ves']);?>"/></div>
								</td>
								<td valign="top" width="80">
									<div><strong>Объем, кв м</strong></div>
									<div><input name="vol" type="text" id="vol" style="width:80px" value="<?php echo htmlspecialchars($mod['vol']);?>"/></div>
								</td>
								<td>
                        ...
                        <div><input name="shortdesc" type="text" id="shortdesc" style="width:99%" value="<?php echo htmlspecialchars($mod['shortdesc']);?>" /></div>
...
<!--
                        ...
                        <div><input name="tags" type="text" id="tags" style="width:99%" value="<?php if (isset($mod['id'])) { echo htmlspecialchars(cmsTagLine('shop', $mod['id'], false)); } ?>" /></div>
-->
                    </td>
                    ...
                    <td width="300" valign="top" style="background:#ECECEC;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="checklist">
                            ...
                            <tr>
                                <td width="20"><input type="checkbox" name="is_hit" id="is_hit" value="1" <?php if ($mod['is_hit']) { echo 'checked="checked"'; } ?>/></td>
                                <td><label for="is_hit"><strong>Хит продаж</strong></label></td>
                            </tr>
                            <tr>
                                <td width="20"><input type="checkbox" name="is_spec" id="is_spec" value="1" <?php if ($mod['is_spec']) { echo 'checked="checked"'; } ?>/></td>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="checklist" style="margin-top:5px;">
                            <tr>
                                <td width="20"><input type="checkbox" onclick="$('#file_div').toggle();$('#will_del').toggle()" name="is_digital" id="is_digital" value="1" <?php if ($mod['is_digital']) { echo 'checked="checked"'; } ?>/></td>
                        ...
                        <div id="file_div" style="margin-bottom:10px;margin-top:2px;<?php if (!$mod['is_digital']) { echo 'display:none'; } ?>">
                        ...
                        <div>
                            <select name="vendor_id" style="width:100%">
                                <option value="0" <?php if(!$mod['vendor_id']){ echo 'selected="selected"'; }?>>---</option>
                        ...
                        <div>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td><input type="text" name="url" value="<?php echo htmlspecialchars($mod['url']); ?>" style="width:100%"/></td>
                ...
                $mod['config']['icon'] = 'shop_category.png';
				 ...
				 if(isset($_REQUEST['item_id'])){
					 ...
					 if (mysqli_num_rows($result)){
                        ...
                        if (!$mod['config']['icon']) { $mod['config']['icon'] = 'shop_category.png'; }
					 }
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td><input name="title" type="text" id="title" style="width:99%" value="<?php echo htmlspecialchars($mod['title']);?>" /></td>
                                    <td><input name="icon" type="file" /></td>
                                    <td style="padding-left:6px"><input name="tpl" type="text" style="width:98%" value="<?php echo htmlspecialchars($mod['tpl']);?>" /></td>
                                </tr>
                            </table>
                        ...
                        <td width="300" valign="top" style="background:#ECECEC;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="checklist">
                                ...
                                <tr>
                                    <td width="20"><input type="checkbox" name="is_catalog" id="is_catalog" value="1" <?php if ($mod['is_catalog']) { echo 'checked="checked"'; } ?>/></td>
                                    <td><label for="is_catalog"><strong>Режим каталога (не показывать цены)</strong></label></td>
                                </tr>
                                <tr>
                                    <td width="20"><input type="checkbox" name="is_xml" id="is_xml" value="1" <?php if ($mod['is_xml']) { echo 'checked="checked"'; } ?>/></td>
            ...
            <form id="addform" name="addform" method="post" action="index.php?view=components&do=config&id=<?php echo $_REQUEST['id'];?>">
                <table width="584" border="0" cellspacing="5" class="proptable">
                    ...
                    <tr>
                        ...
                        <td valign="top"><label>
                            <select name="sign" id="sign" style="width:307px" onchange="toggleDiscountLimit()">
                                <option value="-1" <?php if (@$mod['sign']==-1) {echo 'selected';} ?>>Скидка</option>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <input name="amount" type="text" id="amount" style="width:80px" value="<?php if ($opt=='edit_discount') { echo $mod['amount']; } ?>"/>
                            <select name="is_percent" id="is_percent" style="width:60px">
                                <option value="1" <?php if ($mod['is_percent']) {echo 'selected';} ?>>%</option>
                                <option value="0" <?php if (!$mod['is_percent']) {echo 'selected';} ?>><?php echo $cfg['currency']; ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td valign="top"><label>
                            <select name="is_forever" id="sign" style="width:307px">
                                <option value="1" <?php if ($mod['is_forever']) {echo 'selected';} ?>>Неограничен</option>
                                <option value="0" <?php if (!$mod['is_forever']) {echo 'selected';} ?>>До указанной даты</option>
                            </select>
                        </label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td valign="top">
                            ...
                            <span class="hinttext">Если не выбрано, действует<br/> для всех категорий магазина.</span>
                            <br/>
                    ...
                    <tr>
                        <td valign="top">
                            <strong>Только для групп:</strong><br/>
                            <span class="hinttext">Если не выбрано, действует<br/> для всех пользователей</span>
                            <br/>
                            <span class="hinttext">Можно выбрать несколько,<br/> удерживая CTRL</span>
                        </td>
                        <td valign="top">
            ...
            <form id="addform" name="addform" method="post" action="index.php?view=components&do=config&id=<?php echo $_REQUEST['id'];?>">
                ...
                <table width="600" border="0" cellspacing="5" class="proptable">
                    <tr>
                        ...
                        <td width="315" valign="top"><input name="title" type="text" id="title" style="width:300px" value="<?php echo htmlspecialchars($mod['title']);?>"/></td>
                    </tr>
                    <tr>
                        ...
                        <td valign="top">
                            <select name="fieldtype" id="fieldtype" style="width:307px" onchange="">
                                ...
                                <option value="int" <?php if (@$mod['fieldtype']=='int') {echo 'selected';} ?>>Число</option>
                                ...
                                <option value="gmap" <?php if (@$mod['fieldtype']=='gmap') {echo 'selected';} ?>>Адрес на Google Maps</option>
                                <option value="ymap" <?php if (@$mod['fieldtype']=='ymap') {echo 'selected';} ?>>Адрес на Яндекс.Картах</option>
                    ...
                    <tr>
                        ...
                        <td width="315" valign="top"><input name="units" type="text" id="units" style="width:300px" value="<?php echo htmlspecialchars($mod['units']);?>"/></td>
                    </tr>
                    <tr>
                        <td><strong>Значение характеристики: </strong></td>
                        <td valign="top">
                            <input name="is_custom" type="radio" value="0" <?php if (@!$mod['is_custom']) { echo 'checked="checked"'; } ?>/> Устанавливается продавцом<br/>
                            <input name="is_custom" type="radio" value="1" <?php if (@$mod['is_custom']) { echo 'checked="checked"'; } ?>/> Выбирается покупателем
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <input name="is_filter" type="radio" value="1" <?php if (@$mod['is_filter']) { echo 'checked="checked"'; } ?> onclick="$('input[name=is_filter_many]').attr('disabled', '');" /> Да
                            <input name="is_filter" type="radio" value="0" <?php if (@!$mod['is_filter']) { echo 'checked="checked"'; } ?> onclick="$('input[name=is_filter_many]').attr('disabled', 'disabled');$('input[name=is_filter_many][value=0]').attr('checked', 'checked');" /> Нет
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <form id="addform" name="addform" method="post" action="index.php?view=components&do=config&id=<?php echo $_REQUEST['id'];?>">
                <table width="600" border="0" cellspacing="5" class="proptable">
                    <tr>
                        ...
                        <td width="" valign="top"><input name="title" type="text" id="title" style="width:98%" value="<?php echo htmlspecialchars($mod['title']);?>"/></td>
                    </tr>
                    <tr>
                        <td><strong>Показывать на сайте: </strong></td>
                        <td valign="top">
                    ...
                    <tr>
                        ...
                        <td width="" valign="top"><input name="price" type="text" id="price" style="width:100px" value="<?php echo htmlspecialchars($mod['price']);?>"/> <?php echo $cfg['currency']; ?></td>
                    </tr>
                    <tr>
                        <td width="200"><strong>Доступно при заказе от:</strong></td>
                        <td width="" valign="top"><input name="minsumm" type="text" id="minsumm" style="width:100px" value="<?php echo htmlspecialchars($mod['minsumm']);?>"/> <?php echo $cfg['currency']; ?></td>
                    </tr>
                    <tr>
                        ...
                        <td width="" valign="top">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right:2px"><input name="freesumm" type="text" id="freesumm" style="width:100px" value="<?php echo htmlspecialchars($mod['freesumm']);?>"/> <?php echo $cfg['currency']; ?> или</td>
                                    <td width="16"><input type="checkbox" id="nofree" name="nofree" value="1" <?php if ($mod['nofree']) { echo 'checked="checked"'; } ?>/></td>
                ...
                <p>
                    <input name="add_mod" type="submit" id="add_mod" <?php if ($opt=='add_delivery') { echo 'value="Создать"'; } else { echo 'value="Сохранить изменения"'; } ?> />
                    <input name="back" type="button" id="back" value="Отмена" onclick="window.location.href='index.php?view=components';"/>
                    <input name="opt" type="hidden" id="do" <?php if ($opt=='add_delivery') { echo 'value="submit_delivery"'; } else { echo 'value="update_delivery"'; } ?> />
                    <?php
...
//=================================================================================================//
	...
	if ($opt == 'config') {
        ...
        if (!$cfg['ord_req']) { $cfg['ord_req'] = array(); }
        ...
        <div id="general">
            <table width="" border="0" cellpadding="5" cellspacing="0" class="proptable" style="border:none">
                <tr>
                    ...
                    <td valign="top">
                        <label><input name="is_shop" type="radio" value="1" <?php if (@$cfg['is_shop']) { echo 'checked="checked"'; } ?>/> Магазин</label>
                        <label><input name="is_shop" type="radio" value="0" <?php if (@!$cfg['is_shop']) { echo 'checked="checked"'; } ?>/> Каталог</label>
                    </td>
                </tr>
                <tr>
                    <td width="260">
                    ...
                    <td valign="top">
                        <label><input name="show_decimals" type="radio" value="2" <?php if (@$cfg['show_decimals']==2) { echo 'checked="checked"'; } ?>/> Дробные (x.xx)</label>
                        <label><input name="show_decimals" type="radio" value="0" <?php if (@!$cfg['show_decimals']) { echo 'checked="checked"'; } ?>/> Целые (x)</label>
                    </td>
                </tr>
                <tr>
                    <td width="260">
        ...
        <div id="items">
            <table width="" border="0" cellpadding="5" cellspacing="0" class="proptable" style="border:none">
                <tr>
                    ...
                    <td>
                        <select id="qty_mode" name="qty_mode" style="width:280px">
                            <option value="any" <?php if ($cfg['qty_mode']=='any') { echo 'selected="selected"'; } ?>>любое количество</option>
                            <option value="qty" <?php if ($cfg['qty_mode']=='qty') { echo 'selected="selected"'; } ?>>в пределах наличия на складе</option>
                            <option value="one" <?php if ($cfg['qty_mode']=='one') { echo 'selected="selected"'; } ?>>весь товар штучный</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <select id="items_orderto" name="items_orderto" style="width:147px">
                            <option value="asc" <?php if ($cfg['items_orderto']=='asc') { echo 'selected="selected"'; } ?>>по возрастанию</option>
                            <option value="desc" <?php if ($cfg['items_orderto']=='desc') { echo 'selected="selected"'; } ?>>по убыванию</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input name="track_qty" type="radio" value="1" <?php if (@$cfg['track_qty']) { echo 'checked="checked"'; } ?>/> Да
                        <input name="track_qty" type="radio" value="0" <?php if (@!$cfg['track_qty']) { echo 'checked="checked"'; } ?>/> Нет
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="show_hit_img" type="radio" value="1" <?php if (@$cfg['show_hit_img']) { echo 'checked="checked"'; } ?>/> Да
                        <input name="show_hit_img" type="radio" value="0" <?php if (@!$cfg['show_hit_img']) { echo 'checked="checked"'; } ?>/> Нет
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="show_comments" type="radio" value="1" <?php if (@$cfg['show_comments']) { echo 'checked="checked"'; } ?>/> Да
                        <input name="show_comments" type="radio" value="0" <?php if (@!$cfg['show_comments']) { echo 'checked="checked"'; } ?>/> Нет
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="show_items_nav" type="radio" value="1" <?php if (@$cfg['show_items_nav']) { echo 'checked="checked"'; } ?>/> Да
                        <input name="show_items_nav" type="radio" value="0" <?php if (@!$cfg['show_items_nav']) { echo 'checked="checked"'; } ?>/> Нет
                    </td>
                </tr>
                <tr>
                    <td width=""><strong>Показывать связанные товары: </strong></td>
                    <td>
                        <input name="show_related" type="radio" value="1" <?php if (@$cfg['show_related']) { echo 'checked="checked"'; } ?>/> Да
                        <input name="show_related" type="radio" value="0" <?php if (@!$cfg['show_related']) { echo 'checked="checked"'; } ?>/> Нет
                    </td>
                </tr>
                <tr>
        ...
        <div id="cats">
            <table width="" border="0" cellpadding="5" cellspacing="0" class="proptable" style="border:none">
                ...
                <tr>
                    ...
                    <td>
                        <input name="show_filter_vendors" type="radio" value="1" <?php if (@$cfg['show_filter_vendors']) { echo 'checked="checked"'; } ?>/> Да
                        <input name="show_filter_vendors" type="radio" value="0" <?php if (@!$cfg['show_filter_vendors']) { echo 'checked="checked"'; } ?>/> Нет
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="show_vendors" type="radio" value="1" <?php if (@$cfg['show_vendors']) { echo 'checked="checked"'; } ?>/> Да
                        <input name="show_vendors" type="radio" value="0" <?php if (@!$cfg['show_vendors']) { echo 'checked="checked"'; } ?>/> Нет
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="compare_prices" type="radio" value="1" <?php if (@$cfg['compare_prices']) { echo 'checked="checked"'; } ?>/> Да
                        <input name="compare_prices" type="radio" value="0" <?php if (@!$cfg['compare_prices']) { echo 'checked="checked"'; } ?>/> Нет
                    </td>
                </tr>
                <tr>
                    <td width=""><strong>Показывать характеристики товаров: </strong></td>
                    <td>
                        <input name="show_cat_chars" type="radio" value="1" <?php if (@$cfg['show_cat_chars']) { echo 'checked="checked"'; } ?>/> Да
                        <input name="show_cat_chars" type="radio" value="0" <?php if (@!$cfg['show_cat_chars']) { echo 'checked="checked"'; } ?>/> Нет
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <select id="after_cart" name="after_cart" style="width:280px">
                            <option value="cart" <?php if ($cfg['after_cart']=='cart') { echo 'selected="selected"'; } ?>>переходить в корзину</option>
                            <option value="stay" <?php if ($cfg['after_cart']=='stay') { echo 'selected="selected"'; } ?>>оставаться на той же странице</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td valign="top"><strong>Поля обязательные для заполнения<br/> при создании заказа:</strong></td>
                    <td>
                        <div>
        ...
        <div id="notify">
            <table width="" border="0" cellpadding="5" cellspacing="0" class="proptable" style="border:none">
                <tr>
                    ...
                    <td>
                        <input name="notify_send" type="radio" value="1" <?php if (@$cfg['notify_send']) { echo 'checked="checked"'; } ?>/> Да
                        <input name="notify_send" type="radio" value="0" <?php if (@!$cfg['notify_send']) { echo 'checked="checked"'; } ?>/> Нет
                    </td>
                </tr>
                <tr>
                    <td><strong>Отправлять уведомление о заказе покупателю: </strong></td>
                    <td>
                        <input name="notify_send_customer" type="radio" value="1" <?php if (@$cfg['notify_send_customer']) { echo 'checked="checked"'; } ?>/> Да
                        <input name="notify_send_customer" type="radio" value="0" <?php if (@!$cfg['notify_send_customer']) { echo 'checked="checked"'; } ?>/> Нет
                    </td>
                </tr>
                <tr>
                    <td>
                        <strong>Адрес для уведомлений продавца: </strong><br/>
                        <span class="hinttext">
		...
		<table width="100%" border="0">
			<tr>
				<td width="50%">
					...
					<div id="config_tabs" style="margin-top:12px;">
						...
						<div id="url">
							<p style="font-size:14px;color:#09C">1) Ссылка на прайс-лист для <b>Kaspi KZ</b> (последний от <?php echo $lastdate['mday'] . '.' . $lastdate['mon'] . '.' . $lastdate['year'] . ', ' . $lastdate['hours'] . ':' .$lastdate['minutes'] ; ?>):</p>
				...
				<td width="50%">
					...
					<div id="config_tabse" style="margin-top:12px;">
						...
						<div id="urle">
							<p style="font-size:14px;color:#09C">2) Ссылка на прайс-лист для <b>Google Merchant</b> (последний от <?php echo $lastmdate['mday'] . '.' . $lastmdate['mon'] . '.' . $lastmdate['year'] . ', ' . $lastmdate['hours'] . ':' .$lastmdate['minutes'] ; ?>):</p>
			...
			<tr>
				<td width="50%">
					...
					<select style="width:150px;" name="catrehiu647uii">
...
<p style="margin-top:0px;color:gray;border-bottom:dotted 1px gray;padding-bottom:10px;">
 ...
 <form action="index.php?view=components&amp;do=config&amp;id=<?php echo $_REQUEST['id'];?>" method="post" id="import" target="_self" enctype="multipart/form-data">
    ...
    <table cellpadding="4" cellspacing="0" border="0" width="" class="proptable" style="border:none">
        ...
        <tr>
            <td>
                <strong>Категория по-умолчанию:</strong><br/>
                <span class="hinttext">
        ...
        <tr>
            <td>
                <strong>Имеющиеся товары:</strong><br/>
                <span class="hinttext">При совпадении по артикулу</span>
            </td>
            <td valign="top">
