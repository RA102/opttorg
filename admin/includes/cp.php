...
function printLangPanel($target, $target_id, $field)
{
    ...
    if (count($langs) > 1) {
        ...
        foreach ($langs as $lang) { ?>
            ...
            &nbsp;<a class="ajaxlink editfieldlang" href="#"
                     onclick="return editFieldLang('<?php echo $lang; ?>','<?php echo $target; ?>','<?php echo $target_id; ?>','<?php echo $field; ?>', this);"><strong><?php echo mb_strtoupper($lang); ?></strong></a>&nbsp;
...
function cpHead()
{
    ...
    $inPage->addHeadJS('components/shop/js/checkItemVencode.js');
        ...
        <ul id="nav">
            <?php if (cmsUser::isAdminCan('admin/menu', $adminAccess)) { ?>
                <li>
                    ...
                    <ul>
                        <li><a class="add"
                               href="index.php?view=menu&do=add"><?php echo $_LANG['AD_MENU_POINT_ADD']; ?></a></li>
                        <li><a class="add"
                               href="index.php?view=menu&do=addmenu"><?php echo $_LANG['AD_MENU_ADD']; ?></a></li>
            ...
            <?php if (cmsUser::isAdminCan('admin/modules', $adminAccess)) { ?>
                <li>
                    ...
                    <ul>
                        <li><a class="install"
                               href="index.php?view=install&do=module"><?php echo $_LANG['AD_MODULES_SETUP']; ?></a>
                        </li>
                        <li><a class="add"
                               href="index.php?view=modules&do=add"><?php echo $_LANG['AD_MODULE_ADD']; ?></a></li>
            ...
            <?php if (cmsUser::isAdminCan('admin/content', $adminAccess)) { ?>
                <li>
                    ...
                    <ul>
                        ...
                        <li><a class="arhive"
                               href="index.php?view=arhive"><?php echo $_LANG['AD_ARTICLES_ARCHIVE']; ?></a></li>
                        <li><a class="add"
                               href="index.php?view=cats&do=add"><?php echo $_LANG['AD_CREATE_SECTION']; ?></a></li>
                        <li><a class="add"
                               href="index.php?view=content&do=add"><?php echo $_LANG['AD_CREATE_ARTICLE']; ?></a></li>
                    </ul>
                </li>
            <?php } ?>
            <?php if (cmsUser::isAdminCan('admin/components', $adminAccess)) { ?>
                <li>
                    ...
                    <ul>
                        <li><a class="install"
                               href="index.php?view=install&do=component"><?php echo $_LANG['AD_INSTALL_COMPONENTS']; ?></a>
                        </li>
                        <?php
                        ...
                        if ($total_count) {
                            ...
                            foreach ($components as $com) {
                                ...
                                if ($com['published'] && (file_exists('components/' . $com['link'] . '/backend.php')) && cmsUser::isAdminCan('admin/com_' . $com['link'], $adminAccess)) { ?>
                                    ...
                                    <li>
                                        <a style="margin-left:5px; background:url(/admin/images/components/<?php echo $com['link']; ?>.png) no-repeat 6px 6px;"
                                           href="index.php?view=components&do=config&link=<?php echo $com['link']; ?>">
                                            <?php echo $com['title']; ?>
                                        </a>
                                    </li>
                        ...
                        if ($total_count != $showed_count && $inUser->id == 1) {
                            ...
                            ?>
                            <li><a class="list" href="index.php?view=components"><?php echo $_LANG['AD_SHOW_ALL']; ?>
                                    ...</a></li>
                            <?php
            ...
            <?php if (cmsUser::isAdminCan('admin/plugins', $adminAccess)) { ?>
                <li>
                    ...
                    <ul>
                        <li>
                            <a class="install" href="index.php?view=install&do=plugin"><?php echo $_LANG['AD_INSTALL_PLUGINS']; ?></a>
                        </li>
                        <li>
                            <a href="index.php?view=plugins" class="plugins"><?php echo $_LANG['AD_PLUGINS']; ?></a>
                        </li>
                        <?php if (cmsUser::isAdminCan('admin/filters', $adminAccess)) { ?>
                            <li>
                                <a href="index.php?view=filters" class="filters"><?php echo $_LANG['AD_FILTERS']; ?></a>
                            </li>
                        <?php } ?>
                    </ul>
                </li>
            ...
            <?php if (cmsUser::isAdminCan('admin/users', $adminAccess)) { ?>
                <li>
                    ...
                    <ul class="" style="width: auto;">
                        ...
                        <li><a href="index.php?view=userbanlist" class="banlist"><?php echo $_LANG['AD_BANLIST']; ?></a>
                        </li>
                        <li><a class="users"
                               href="index.php?view=usergroups"><?php echo $_LANG['AD_USERS_GROUP']; ?></a></li>
                        <li><a class="add" href="index.php?view=users&do=add"><?php echo $_LANG['AD_USER_ADD']; ?></a>
                        </li>
                        <li><a class="add"
                               href="index.php?view=usergroups&do=add"><?php echo $_LANG['AD_CREATE_GROUP']; ?></a></li>
                        <li><a class="config"
                               href="index.php?view=components&do=config&link=users"><?php echo $_LANG['AD_PROFILE_SETTINGS']; ?></a>
                        </li>
                        <li>
                            <a href="index.php?view=users" class="user"><?php echo $_LANG['UPLOADING_USERS']?></a>
                        </li>
                    </ul>
                </li>
            <?php } ?>
            <?php if (cmsUser::isAdminCan('admin/config', $adminAccess)) { ?>
                <li>
                    ...
                    <ul>
                        <li><a class="config" href="index.php?view=config"><?php echo $_LANG['AD_SITE_SETTING']; ?></a>
                        </li>
                        ...
                        <li><a class="phpinfo" href="index.php?view=phpinfo"><?php echo $_LANG['AD_PHP_INFO']; ?></a>
                        </li>
                        <li><a class="clearcache" href="index.php?view=clearcache"><?php echo $_LANG['AD_CLEAR_SYS_CACHE']; ?></a></li>
                    </ul>
                </li>
                <li>
                    <a class="plugins"><?php echo $_LANG['OTHER'] ?></a>
                    <ul class="" style="width: auto;">
            ...
            <?php } ?>
            <li>
                <a href="http://www.instantcms.ru/wiki" target="_blank"
                   class="help"><?php echo $_LANG['AD_DOCS']; ?></a>
            </li>
        </ul>
    </div>
...
function cpToolMenu($toolmenu_list)
{
    ...
    if ($toolmenu_list) {
        ...
        foreach ($toolmenu_list as $toolmenu) {
            ...
            echo '<a class="' . $class_selected . ' toolmenuitem uittip" href="' . $toolmenu['link'] . '" title="' . $toolmenu['title'] . '" ' . $target . '><img class="img-responsive" src="images/toolmenu/' . $toolmenu['icon'] . '" border="0" /></a>';
        }
        echo '</td></tr></table>';
    }
...
function cpListTable($table, $_fields, $_actions, $where = '', $orderby = 'title')
{
    ...
    if ($inDB->num_rows($result)) {
        ...
        while ($item = $inDB->fetch_assoc($result)) {
            ...
            if ($is_actions) {
                echo '<td width="110" class="' . $row_class . '" align="right" valign="middle"><div class="1" style="padding-right:8px">';
